...
class PlayState( State ):
    def __init__( self , screen , gameController , numDisks , color ):
        ...
        self.mouseClickSFX = pygame.mixer.Sound( os.path.join( os.path.join( 'data' , 'sfx' ) , 'sound5a.wav' ))
        self.mouseClickSFX.set_volume(self.GameController.UserSettings["[SFXVolume]"]/100.0)
        self.diskClickSFX = pygame.mixer.Sound( os.path.join( os.path.join( 'data' , 'sfx' ) , 'sound3a.wav' ))
        self.diskClickSFX.set_volume(self.GameController.UserSettings["[SFXVolume]"]/100.0)
        self.diskReleaseSFX = pygame.mixer.Sound( os.path.join( os.path.join( 'data' , 'sfx' ) , 'sound2a.wav' ))
        self.diskReleaseSFX.set_volume(self.GameController.UserSettings["[SFXVolume]"]/100.0)
        
        self.playList = [ "bigmojo.mp3", "bollywood-bhangra.mp3", "destination-goa.mp3", "india-bazaar.mp3", "indian-summer.mp3", "jalandhar.mp3" ]
    ...
    def PlayBGMusic( self ):
        song = random.randrange( 0, len( self.playList ) )
        pygame.mixer.music.load( os.path.join( os.path.join( 'data' , 'music' ) , self.playList[song] ))
